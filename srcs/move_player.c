...
/*   Updated: 2025/02/19 14:24:28 by elilliu          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_player_up(t_data *data)
{
	...
	x = ((int)data->player.x + (int)data->player.delta_x) / 64;
	y = ((int)data->player.y + (int)data->player.delta_y) / 64;
...
void	move_player_left(t_data *data)
{
	...
	x = ((int)data->player.x + (int)delta_x) / 64;
	y = ((int)data->player.y + (int)delta_y) / 64;
	if (data->map.tab[y][x] != WALL)
	{
